...
To explore the second question, we draw on DfE data on early years provision at the local authority level:

- **EYP take-up (3–4 year olds)**
  Percentage of eligible children registered for the universal funded early education entitlement.
...
- **Ofsted quality score**
  Weighted average of provider Ofsted ratings (4 = Outstanding, 1 = Inadequate), reflecting the overall quality
...
- **Graduate staff in PVI settings**
  Percentage of children in private, voluntary, and independent settings with access to graduate-level staff.
...
relationships persist after controlling for area-level income.

## Key Findings

<figure>
  <img src="docs/map_iod.png" alt="Choropleth maps of England showing each IoD domain and GLD by local authority district">
  <figcaption>Indices of deprivation and Good Level of Development by local authority district, all z-scored. Most domains share a similar spatial pattern, with higher deprivation in the North and Midlands. Barriers and Living Environment are concentrated in London.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Cross-validated R² for each IoD domain predicting GLD, with and without controlling for household income (GDHI). Health, Employment, IDACI, and Education remain predictive after the income control.</figcaption>
</figure>

The provision measures I tested - early education take-up, Ofsted quality, SEN support, and graduate staff rates -
showed no meaningful association with GLD outcomes, either raw or after controlling for wealth and deprivation.
...
<figure>
  ...
  <figcaption>Provision factors vs GLD (no controls). None show a meaningful relationship.</figcaption>
</figure>
...
quality, SEN support, graduate staff rates) showed no meaningful association with GLD outcomes, whether raw,
wealth-controlled, or after removing the variance explained by deprivation.

This doesn't mean provisions don't matter. The wider literature suggests that what matters most is the quality of
...
tautological. Wealth correlates with nearly everything — both the deprivation measures and GLD.

Overall, several deprivation domains - including IDACI, which directly measures child income deprivation -
remain predictive of GLD after controlling for household income, suggesting that these deprivation indices capture
dimensions of disadvantage beyond wealth alone. This could point to possible avenues for targeted support, though the
measures used here are relatively coarse and the analysis is exploratory.
